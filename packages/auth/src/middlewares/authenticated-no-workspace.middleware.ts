...
import {
  AuthenticationTokenPublicDataNoWorkspaceInterface,
  TokenProblem,
...
export type AuthenticatedNoWorkspaceResponse = HttpResponse & {
  user: AuthenticationTokenPublicDataNoWorkspaceInterface;
};

@Service()
export class AuthenticatedNoWorkspaceMiddleware implements Middleware {
